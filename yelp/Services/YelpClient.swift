...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    func searchWithTerm(_ term: String, sort: YelpSortMode?, categories: [String]?, deals: Bool?,offset: Int = 0, completion: @escaping ([Business]?, Error?) -> Void) -> AFHTTPRequestOperation {
