...
class Business: NSObject {
    ...
    class func searchWithTerm(term: String, sort: YelpSortMode?, categories: [String]?, deals: Bool?, distance: String?, offset: Int = 0, completion: @escaping ([Business]?, Error?) -> Void) -> Void {
